...
<body>
	<?php
		...
		echo "<div id='upper'>
				<h1>Women's Office Wear</h1>
			<div>";
		echo "<table>";
		$conn = mysql_connect("localhost","root","") or die(mysql_error());
		$dbcon = mysql_select_db("shoppingCart", $conn) or die(mysql_error());
		$sql = "SELECT productId, image, productName, price FROM productTable, categoryTable where productTable.catId = categoryTable.catId AND categoryTable.catName = 'Office Wear' AND productTable.gender = 'Ladies'";
